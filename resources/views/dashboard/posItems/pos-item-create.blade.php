<x-layouts.admin title="Add New POS Item">
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <div>
            <h2 style="font-size:22px;font-weight:800;color:#0f172a;margin:0;">Add New POS Item</h2>
            <p style="font-size:13.5px;color:#64748b;margin:4px 0 0 0;">Add a new item directly to the POS inventory
                catalogue.</p>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                required placeholder="e.g. Sourdough Loaf">
                            @error('name')
                                <span
                        ...
                        <div class="form-grid-2">
                            <div class="form-group" style="margin-bottom:0;">
                                ...
                                <input type="text" name="sku" id="sku" class="form-control"
                                    value="{{ old('sku') }}" placeholder="Auto-generate if blank">
                            </div>
                            <div class="form-group" style="margin-bottom:0;">
                                <label class="form-label" for="barcode">Barcode</label>
                                <input type="text" name="barcode" id="barcode" class="form-control"
                                    value="{{ old('barcode') }}" placeholder="Auto-generate if blank">
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <select name="product_type" id="product_type" class="form-control" required>
                                <option value="ready_made" {{ old('product_type') == 'ready_made' ? 'selected' : '' }}>
                                    Ready Made</option>
                                <option value="raw_material"
                                    {{ old('product_type') == 'raw_material' ? 'selected' : '' }}>Raw Material</option>
                                <option value="finished_product"
                                    {{ old('product_type') == 'finished_product' ? 'selected' : '' }}>Finished Product
                                    (Bakery)</option>
                            </select>
                        </div>
                            ...
                            <div class="form-group" style="margin-bottom:0;">
                                ...
                                <select name="tax_id" id="tax_id" class="form-control">
                                    ...
                                    @foreach ($taxes as $tax)
                                        <option value="{{ $tax->id }}"
                                            {{ old('tax_id', $taxes->where('is_default', true)->first()?->id) == $tax->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <textarea name="description" id="description" rows="3" class="form-control"
                                placeholder="Describe the product (ingredients, allergens, etc.)...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-grid-3">
                            <div class="form-group" style="margin-bottom:0;">
                                ...
                                <input type="number" step="0.01" name="cost_price" id="cost_price"
                                    class="form-control" value="{{ old('cost_price', '0.00') }}" required
                                    min="0">
                                @error('cost_price')
                                    <span
                                        style="color:#ef4444;font-size:12px;margin-top:4px;display:block;">{{ $message }}</span>
                            ...
                            <div class="form-group" style="margin-bottom:0;">
                                ...
                                <input type="number" step="0.01" name="sale_price" id="sale_price"
                                    class="form-control" value="{{ old('sale_price', '0.00') }}" required
                                    min="0">
                                @error('sale_price')
                                    <span
                                        style="color:#ef4444;font-size:12px;margin-top:4px;display:block;">{{ $message }}</span>
                            ...
                            <div class="form-group" style="margin-bottom:0;">
                                ...
                                <input type="number" step="0.01" name="mrp_price" id="mrp_price"
                                    class="form-control" value="{{ old('mrp_price', '0.00') }}" required
                                    min="0">
                                @error('mrp_price')
                                    <span
                                        style="color:#ef4444;font-size:12px;margin-top:4px;display:block;">{{ $message }}</span>
